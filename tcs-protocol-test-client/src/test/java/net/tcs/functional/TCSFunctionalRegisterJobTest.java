...
public class TCSFunctionalRegisterJobTest {
    ...
    public void setup(@Optional("") String rmqIP, @Optional("4") int partitionCount, @Optional("") String configFile)
        ...
        if (StringUtils.isNotEmpty(configFile)) {
            tcsClientRuntime = TCSClientFactory.createTCSClient(configFile);
        } else {
    ...
    public void testJobExecutionSuccess() throws IOException {
        ...
        registerJobTestJob3();
        registerJobTestJob4();
        registerParallelJobTest();
        registerJobTestJob6();
        registerJobTestJobWithStep();
    }

    private String registerJobTestJob() throws IOException {
        final String jobName = "testjob-" + UUID.randomUUID().toString();

        final TcsTaskExecutionEndpoint t1Endpoint = new TcsTaskExecutionEndpoint(TCSConstants.TCS_EXECUTOR_EXCHANGE,
                "tcs.rkey-t1");

        final TcsTaskExecutionEndpoint t2Endpoint = new TcsTaskExecutionEndpoint(TCSConstants.TCS_EXECUTOR_EXCHANGE,
                "tcs.rkey-t2");

        final TcsTaskExecutionEndpoint t3Endpoint = new TcsTaskExecutionEndpoint(TCSConstants.TCS_EXECUTOR_EXCHANGE,
                "tcs.rkey-t3");

        final TcsTaskExecutionEndpoint t4Endpoint = new TcsTaskExecutionEndpoint(TCSConstants.TCS_EXECUTOR_EXCHANGE,
                "tcs.rkey-t4");
    ...
    private String registerJobTestJob2() throws IOException {
    ...
    private String registerJobTestJob3() throws IOException {
        ...
        final TcsTaskExecutionEndpoint t5Endpoint = new TcsTaskExecutionEndpoint(TCSConstants.TCS_EXECUTOR_EXCHANGE,
                "tcs.rkey-t555");
        final JobSpec job = TCSClientFactory.createJobSpec(jobName);
    ...
    private String registerJobTestJob4() throws IOException {

        final String jobName = "testjob-" + UUID.randomUUID().toString();

        final TcsTaskExecutionEndpoint t0Endpoint = new TcsTaskExecutionEndpoint(TCSConstants.TCS_EXECUTOR_EXCHANGE,
                "tcs.rkey-t0000");
        final TcsTaskExecutionEndpoint t1Endpoint = new TcsTaskExecutionEndpoint(TCSConstants.TCS_EXECUTOR_EXCHANGE,
                "tcs.rkey-t1111");
        final TcsTaskExecutionEndpoint t2Endpoint = new TcsTaskExecutionEndpoint(TCSConstants.TCS_EXECUTOR_EXCHANGE,
        ...
        final TcsTaskExecutionEndpoint t5Endpoint = new TcsTaskExecutionEndpoint(TCSConstants.TCS_EXECUTOR_EXCHANGE,
                "tcs.rkey-t5555");
        final TcsTaskExecutionEndpoint t6Endpoint = new TcsTaskExecutionEndpoint(TCSConstants.TCS_EXECUTOR_EXCHANGE,
                "tcs.rkey-t6666");
        final TcsTaskExecutionEndpoint t7Endpoint = new TcsTaskExecutionEndpoint(TCSConstants.TCS_EXECUTOR_EXCHANGE,
                "tcs.rkey-t7777");
        final TcsTaskExecutionEndpoint t8Endpoint = new TcsTaskExecutionEndpoint(TCSConstants.TCS_EXECUTOR_EXCHANGE,
                "tcs.rkey-t8888");
        final TcsTaskExecutionEndpoint t9Endpoint = new TcsTaskExecutionEndpoint(TCSConstants.TCS_EXECUTOR_EXCHANGE,
                "tcs.rkey-t9999");
    ...
    private String registerParallelJobTest() throws IOException {
    ...
    private String registerJobTestJob6() throws IOException {
    ...
    private String registerJobTestJobWithStep() throws IOException {
