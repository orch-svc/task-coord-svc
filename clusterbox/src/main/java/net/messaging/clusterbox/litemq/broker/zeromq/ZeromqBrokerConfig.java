...
public class ZeromqBrokerConfig implements BrokerConfig {
    ...
    @JsonCreator
    public ZeromqBrokerConfig(@JsonProperty("brokerAddress") String ipAddress,
            @JsonProperty("frontendPort") String frontendPort, @JsonProperty("backendPort") String backendPort,
            @JsonProperty("frontendProtocol") String frontendProtocol,
            @JsonProperty("backendProtocol") String backendProtocol) {
        super();
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ZeromqBrokerConfig other = (ZeromqBrokerConfig) obj;
        if (backendPort == null) {
    ...
    public String toString() {
        return "zeromqBrokerConfig [ipAddress=" + ipAddress + ", frontendPort=" + frontendPort + ", backendPort="
