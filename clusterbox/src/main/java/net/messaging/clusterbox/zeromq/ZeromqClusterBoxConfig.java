...
public class ZeromqClusterBoxConfig implements ClusterBoxConfig {

    private final ZeromqBrokerConfig brokerConfig;
    ...
    public ZeromqClusterBoxConfig(ZeromqBrokerConfig brokerConfig, String clusterBoxName, String clusterBoxId) {
        super();
    ...
    @Override
    public ZeromqBrokerConfig getBrokerConfig() {
        return brokerConfig;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ZeromqClusterBoxConfig other = (ZeromqClusterBoxConfig) obj;
    ...
    public String toString() {
        return "zeromqClusterBoxConfig [brokerConfig=" + brokerConfig + ", clusterBoxName=" + clusterBoxName
