...
//
// final TcsJobRegisterMessageBox jobHandler = new TcsJobRegisterMessageBox();
//
...
//
// TcsCtrlMessageResult<?> resultObjQuery =
// jobHandler.processQueryJob(queryMessage);
// if (resultObjQuery instanceof TcsCtrlMessageResult) {
// final TcsCtrlMessageResult<?> ctrlMsg = resultObjQuery;
// Assert.assertTrue(StringUtils.containsIgnoreCase(ctrlMsg.getResponse().toString(),
// "JOB_NOT_FOUND"));
// }
//
...
// {
// final TcsCtrlMessageResult<?> ctrlMsg = resultObjQuery;
// final SuccessResultMessage<String> resultMsg = new
// SuccessResultMessage(ctrlMsg.getResponse());
//
// final JobDefinition jobDefRead = mapper.readValue(resultMsg.getResponse(),
// JobDefinition.class);
