...
public class BeginTaskMessage {
    ...
    public BeginTaskMessage(String taskName, int taskParallelIndex, String taskId, String jobName, String jobId,
            String shardId, int retryCount, String taskInput, ParentTaskOutput parentTaskOutput) {
    ...
    public String toString() {
        return "BeginTaskMessage [taskName=" + taskName + ", taskParallelIndex=" + taskParallelIndex + ", taskId="
                + taskId + ", jobName=" + jobName + ", jobId=" + jobId + ", shardId=" + shardId + ", retryCount="
                + retryCount + ", taskInput=" + taskInput + ", parentTaskOutput=" + parentTaskOutput + "]";
    }
